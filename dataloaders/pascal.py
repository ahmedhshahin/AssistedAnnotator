...
class VOCSegmentation(data.Dataset):
    ...
    def __init__(self,
        ...
        # Display stats
        self.obj_list = self.obj_list[:cfg['dataset_index']]
    ...
    def __getitem__(self, index):
        ...
        if self.retname:
            ...
            sample['meta'] = {'image': str(self.im_ids[_im_ii]),
                              'object': str(_obj_ii),
                              'category': self.obj_dict[self.im_ids[_im_ii]][_obj_ii] - 1,
...
if __name__ == '__main__':
    ...
    # relaxes = [1,5,10,20,30,40,50,60,70]
    ...
    composed_transforms_tr = transforms.Compose([
        ...
        # tr.Normalize(['crop_image', 'extreme_points']),
        tr.ConcatInputs(elems=('crop_image', 'extreme_points')),
        tr.AddConfidenceMap(elem= 'concat', hm_type = 'l1l2', tau = 7),
        tr.ToTensor()])
    ...
    dataset = VOCSegmentation(split=['train'], transform=composed_transforms_tr, retname=True)
